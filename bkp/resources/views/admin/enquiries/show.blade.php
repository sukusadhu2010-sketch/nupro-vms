                                            ...
                                            @forelse($enquiry->items as $item)
                                                <tr>
                                                    <td>
                                                        ...
                                                        <br><small
                                                            class="text-muted">{{ $item->product->vendor->company }}</small>
                                                    </td>
                            ...
                            <div class="card-body p-0">
                                            ...
                                            <tbody>
                                                @foreach ($enquiry->quotations as $quote)
                                                    <tr
                                                        ...
                                                        <td>
                                                            <small
                                                                class="text-muted">{{ $quote->created_at->format('M d, Y') }}</small>
                                                        </td>
                                ...
                                @else
                                    <div class="text-center py-5">
                                        ...
                                        <p class="text-muted">Click "Convert to Quote" to generate the first quotation.</p>
                ...
                <div class="card shadow-sm sticky-top" style="top: 20px;">
                    <div class="card-body text-center py-4">
                        <a href="{{ route('quotations.create', $enquiry) }}" class="btn btn-success btn-lg w-100 mb-2">
                            <i class="fas fa-file-invoice-dollar me-2"></i>Convert to Quote
                        </a>
