...
// Only allow moving forward or cancelling
            ...
            if ($request->status === 'delivered') {
                try {
                    $this->inventoryService->deductStockFromSalesOrder($salesOrder);
                } catch (\Throwable $e) {
            ...
            return redirect()
                ->route('sales-orders.show', $salesOrder)
                ->with('success', 'Sales order status updated to ' . ucfirst($request->status) . '. Inventory has been updated.');
        }
