...
/**
    ...
    /**
     * Check if this sales order has an active (non-cancelled) invoice.
     */
    public function getHasActiveInvoiceAttribute(): bool
    {
        return $this->invoices()->whereNotIn('status', ['cancelled'])->exists();
    }
