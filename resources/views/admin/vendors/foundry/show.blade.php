...
@section('title', 'Foundry Profile - Admin')
        ...
        <div class="col-12 mb-5">
            <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h1 class="h3 mb-1 fw-bold">{{ $vendor?->name }}</h1>
                        <span class="badge bg-info px-3 py-2 rounded-pill mb-1">FOUNDRY</span>
                ...
                <div class="d-flex gap-2">
                    <a href="{{ route('foundry-vendors.edit', $vendor) }}" class="btn btn-warning px-4 py-2">
                        <i class="fas fa-edit me-1"></i>Edit
                    </a>
                    <a href="{{ route('foundry-vendors.index') }}" class="btn btn-outline-secondary px-4 py-2">
                        <i class="fas fa-list me-1"></i>Foundries List
                    </a>
                </div>
            </div>
        </div>
                        ...
                        <div class="timeline">
                            <div class="timeline-item">
                                ...
                                <div class="timeline-content">
                                    ...
                                    <p class="mb-0">Foundry account created</p>
                                </div>
                            </div>
