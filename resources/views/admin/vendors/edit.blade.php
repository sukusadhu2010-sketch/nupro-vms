                    ...
                    <div class="card-header bg-gradient-warning text-dark p-4 rounded-top-3">
                        <div class="row align-items-center">
                            <div class="col">
                                ...
                                <p class="mb-0 opacity-75">Update vendor account details</p>
                            </div>
                            <div class="col-auto">
                                        ...
                                        <div class="d-flex gap-4 pt-1">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="vendor_type"
                                                    ...
                                                    {{ old('vendor_type', $vendor->vendor_type) === 'FOUNDRY' ? 'checked' : '' }} required>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="vendor_type"
                                                    ...
                                                    {{ old('vendor_type', $vendor->vendor_type) === 'SUB VENDOR' ? 'checked' : '' }} required>
                                                <label class="form-check-label fw-semibold"
