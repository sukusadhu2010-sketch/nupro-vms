...
@section('title', 'Edit SUB VENDOR - Admin')
            ...
            <div class="col-xl-12 col-lg-12">
                <div class="card shadow-lg border-0 rounded-3">
                        ...
                        <div class="row align-items-center">
                            <div class="col">
                                <h3 class="mb-0 fw-bold">
                                    ...
                                    Edit SUB VENDOR: {{ $vendor->name }}
                                </h3>
                                <p class="mb-0 opacity-75">Update SUB VENDOR account details</p>
                            </div>
                            <div class="col-auto">
                    ...
                    <div class="card-body p-5">
                        <form action="{{ route('sub-vendors.update', $vendor) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="d-flex gap-2 pt-4">
                                ...
                                <a href="{{ route('sub-vendors.index') }}"
                                    class="btn btn-outline-secondary  px-4 py-2 shadow me-2">
                                    <i class="fas fa-times me-2"></i>Cancel
                                </a>
                                <a href="{{ route('sub-vendors.show', $vendor) }}"
