...
@section('title', 'Create New SUB VENDOR - Admin')
            ...
            <div class="col-xl-12 col-lg-12">
                <div class="card shadow-lg border-0 rounded-3">
                    <div class="card-header bg-gradient-primary text-white p-4 rounded-top-3">
                        <div class="row align-items-center">
                            <div class="col">
                                ...
                                <p class="mb-0 opacity-75">Create a new SUB VENDOR account and profile</p>
                            </div>
                            <div class="col-auto">
                                <a href="{{ route('sub-vendors.index') }}" class="btn btn-light btn-sm">
                                    <i class="fas fa-arrow-left me-2"></i>Back to sub vendors
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body p-5">
                        <form action="{{ route('sub-vendors.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control form-control-lg bg-light" value="SUB VENDOR" disabled>
                                        <small class="text-muted">All entries in this section are saved as SUB VENDOR.</small>
                                    </div>
                            ...
                            <div class="d-flex gap-2 pt-4">
                                ...
                                <a href="{{ route('sub-vendors.index') }}" class="btn btn-outline-secondary px-4 py-2 shadow">
